      ...
      <div className="container mx-auto px-3.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="relative bg-white border border-primary rounded-xl overflow-hidden group transition-transform duration-300 hover:scale-[1.02]"
            >
              <div className="p-4">
                <h3 className="text-lg font-semibold text-[#6200ea] font-[proximanova]">
                  {project.title}
                </h3>
